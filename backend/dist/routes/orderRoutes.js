...
router.route('/').post(authMiddleware_js_1.protect, orderController_js_1.getOrderItems).get(authMiddleware_js_1.protect, authMiddleware_js_1.admin, orderController_js_1.getOrders);
